...
public class WeChatAdapter2 extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
  ...
  //  private CenterListAdapter centerAdapter;
    ...
    public WeChatAdapter2(Context context, List<WeChatData.ResultBean.ListBean> data) {
