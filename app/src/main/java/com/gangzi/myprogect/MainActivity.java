...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    private void requestPermission() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            MainActivityPermissionsDispatcher.basicPermissionWithCheck(this);
        }
    }
    @NeedsPermission({Manifest.permission.WRITE_EXTERNAL_STORAGE,Manifest.permission.MOUNT_UNMOUNT_FILESYSTEMS})
    void basicPermission(){

    }

    @OnShowRationale({Manifest.permission.WRITE_EXTERNAL_STORAGE,Manifest.permission.MOUNT_UNMOUNT_FILESYSTEMS})
    public void showRationale(final PermissionRequest request){
        new AlertDialog.Builder(this)
                .setMessage("申请应用中所需的权限")
    ...
    @OnPermissionDenied({Manifest.permission.WRITE_EXTERNAL_STORAGE,Manifest.permission.MOUNT_UNMOUNT_FILESYSTEMS})
    public void permissionDenied(){
        Toast.makeText(this, "已拒绝权限", Toast.LENGTH_SHORT).show();
        requestPermission();
    }

    @OnNeverAskAgain({Manifest.permission.WRITE_EXTERNAL_STORAGE,Manifest.permission.MOUNT_UNMOUNT_FILESYSTEMS})
    public void neverAskAgain(){
        Toast.makeText(this, "已拒绝权限，并不再询问", Toast.LENGTH_SHORT).show();
    }
